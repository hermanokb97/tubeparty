...
export const translations = {
  ko: {
    ...
    synced: '동기화됨',
    sharePosition: '위치 공유',
    positionShared: '재생 위치를 공유했어요',
    skip: '스킵',
    voice: '음성',
    language: '언어',
    browseMusic: '음악 탐색',
    participantsWatching: '{count}명 참여 중',
    showControls: '컨트롤 표시',
    ...
    videos: '개 영상',
    delete: '삭제',
    emptyPlaylist: '재생목록이 비어 있어요. 위에서 노래를 검색해 보세요.',
    emptyPlaylistHint: '위에서 노래를 검색해 보세요.',
    ...
    voiceError: '🎤 음성채팅 오류:',
    inviteChecking: '초대 링크를 확인하는 중입니다...',
    inviteReady: '초대 링크가 확인되었습니다. 닉네임만 입력하면 입장할 수 있어요.',
    inviteInvalid: '만료되었거나 잘못된 초대 링크입니다.',
    inviteCreateFailed: '초대 링크를 만들지 못했어요. 다시 시도해주세요.',
  ...
  ja: {
    ...
    synced: '同期済み',
    sharePosition: '位置を共有',
    positionShared: '再生位置を共有しました',
    skip: 'スキップ',
    voice: '音声',
    language: '言語',
    browseMusic: '曲を探す',
    participantsWatching: '{count}人参加中',
    ...
    videos: '本の動画',
    delete: '削除',
    emptyPlaylist: '再生リストは空です。上で曲を検索してみてください。',
    emptyPlaylistHint: '上で曲を検索してみてください。',
    ...
    inviteChecking: '招待リンクを確認しています...',
    inviteReady: '招待リンクを確認しました。ニックネームだけで入室できます。',
    inviteInvalid: '期限切れ、または無効な招待リンクです。',
    inviteCreateFailed: '招待リンクを作成できませんでした。もう一度お試しください。',
  ...
  en: {
    ...
    positionShared: 'Shared playback position',
    skip: 'Skip',
    voice: 'Voice',
    language: 'Language',
    browseMusic: 'Browse music',
    participantsWatching: '{count} watching',
    ...
    videos: ' videos',
    delete: 'Delete',
    emptyPlaylist: 'The playlist is empty. Search for a song above.',
    emptyPlaylistHint: 'Search for a song above.',
    ...
    inviteChecking: 'Checking invite link...',
    inviteReady: 'Invite link verified. Enter a nickname to join.',
    inviteInvalid: 'This invite link is expired or invalid.',
    inviteCreateFailed: 'Failed to create invite link. Please try again.',
